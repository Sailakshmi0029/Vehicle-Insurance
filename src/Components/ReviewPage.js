...
const ReviewPage = () => {
  ...
  const invoiceUrl = `http://192.168.1.200:9090/payment/create?paymentid=${paymentid}&customerid=${customerid}`;
              ...
              <div className="profile-item">
                ...
                {editMode.mobile ? (
                  ...
                  <>
                    ...
                    <button className="btn btn-sm btn-primary mx-2 edit " onClick={() => handleEdit('mobile')} ><i class="fa-solid fa-pen "></i></button>
                  </>
                )}
              </div>
              {otpMode.mobile && (
              ...
              <div className="profile-item">
                ...
                {editMode.email ? (
                  ...
                  <>
                    ...
                    <button className="btn btn-sm btn-primary mx-2" onClick={() => handleEdit('email')}><i class="fa-solid fa-pen"></i></button>
                  </>
                )}
              </div>
              {otpMode.email && (
                ...
                <div className="card rp-card">
                  <div className="rp-card-body ">
                    <div className="d-flex flex-column p-3 flex-md-row">
                      ...
                      <div className="col-7 ps-lg-5 ms-lg-5">
                        <div className="profile-item text-nowrap">
                          <label>IDV&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;</label>
                          <span>{items.idv}</span>
                        </div>
